...
class CashierController extends Controller
{
    ...
    public function getTables()
    {
        ...
        foreach ($tables as $table) {
            ...
            $html .=
                '<button class="btn btn-primary btn-table" data-id="' .
                $table->id .
                '" data-name="' .
                $table->name .
                '">
            <img class="img-fluid" src="' .
                url('/images/table.svg') .
                '"/>
            <br>';
    ...
    public function getMenuByCategory($category_id)
    {
        ...
        foreach ($menus as $menu) {
            ...
            <div class="col-md-3 text-center">
                <a class="btn btn-outline-secondary btn-menu" data-id="' .
                $menu->id .
                '">
                    <img class="img-fluid" src="' .
                url('/menu_images/' . $menu->image) .
                '">
                    <br>
                    ' .
                $menu->name .
    ...
    private function getSaleDetails($sale_id)
    {
        ...
        foreach ($saleDetails as $saleDetail) {
            ...
            <tr>
                ...
                '</td>
                <td>' .
                $saleDetail->menu_price * $saleDetail->quantity .
                '</td>';
            if ($saleDetail->status == 'noConfirm') {
                ...
                $html .=
                    '<td><a data-id="' .
                    $saleDetail->id .
                    '" class="btn btn-danger btn-delete-saledetail"><i class="far fa-trash-alt"></a></td>';
            } else {
                // status == "confirm"
        ...
        if ($showBtnPayment) {
            $html .=
                ...
                '" data-totalAmount="' .
                $sale->total_price .
                '" class="btn btn-success btn-block btn-payment" data-toggle="modal" data-target="#exampleModal">Payment</button>';
        } else {
            $html .=
                '<button data-id="' .
                $sale_id .
    ...
    public function showReceipt($saleID)
    {
        ...
        return view('cashier.showReceipt')
            ->with('sale', $sale)
